...
-(void)viewDidAppear:(BOOL)animated
{
    ...
    NSString *str = [appdelegate.flowerlist objectAtIndex:pagecontrol.currentPage];
...
//    NSLog(@"Btn index==> %i", cbtn.tag);
    ...
    ////////////////////////////////
    NSString *newStr = [appdelegate.flowerlist objectAtIndex:pagecontrol.currentPage];
...
-(void) loadRestOfItem:(int)itemNo{
    ...
    NSString *str = [appdelegate.flowerlist objectAtIndex:itemNo];
    ...
    NSString *flowerlist = @"";
    flowerlist = (NSString *) [appdelegate.flowerlist objectAtIndex:itemNo];
    
    
    int len = [flowerlist length];
    float temp,first;
    temp=((len*35)/2);
    first=(240-temp+5);
    ...
    for (int j=0; j<len; j++)
    {
        ...
        self.image=[[flowerlist substringFromIndex:j] substringToIndex:1];
        int k;
