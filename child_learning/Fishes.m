...
-(void)viewDidAppear:(BOOL)animated
{
    ...
    NSString *str = [appdelegate.fishlist objectAtIndex:pagecontrol.currentPage];
...
-(void) cbuttonclicked:(UIButton *)cbtn
{
    ...
    ////////////////////////////////
    NSString *newStr = [appdelegate.fishlist objectAtIndex:pagecontrol.currentPage];
...
-(void) loadRestOfItem:(int)itemNo{
    ...
    NSString *str1 = [appdelegate.fishbg objectAtIndex:i];
    ...
    NSString *str = [appdelegate.fishlist objectAtIndex:itemNo];
    ...
    NSString *fishlist = @"";
    fishlist = (NSString *) [appdelegate.fishlist objectAtIndex:i];
    
    //       NSLog(@"=====> %@",fishlist);
    
    int len = [fishlist length];
    float temp,first;
    temp=((len*35)/2);
    first=(240-temp);
    ...
    for (int j=0; j<len; j++)
    {
        ...
        self.image=[[fishlist substringFromIndex:j] substringToIndex:1];
